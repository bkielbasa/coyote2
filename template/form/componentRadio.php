...
<!--
	...
	function refreshOptions()
	{
		...
		{
			$('#defaultList ol').append('<li><input type="radio" name="default" value="' + optionList[i].value + '" /> ' + optionList[i + 1].value + '</li>');
		}
	}
...
<li>
	...
	<fieldset id="defaultList">
		<ol>
			...
			<li><?= Form::radio('default', $name, (bool)($name == $default)); ?> <?= $value; ?></li>
			<?php endforeach; ?>
		</ol>
	</fieldset>
</li>
