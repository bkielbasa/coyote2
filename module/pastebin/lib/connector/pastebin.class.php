...
class Connector_Pastebin extends Connector_Document implements Connector_Interface
{
	public function renderForm()
	{
		...
		$fieldset->getElement('page_template')->setValue('pastebin.php');
	...
	public function onAfterSave()
	{
		...
		$result = $connector->getByName('pastebin')->fetchAssoc();
		$route = &$this->load->model('route');
		$name = 'page_' . $this->getId();

		$data = array(
			'url'			=> $this->getLocation() . '/:id',
			'name'			=> $name,
			'page'			=> $this->getId(),
