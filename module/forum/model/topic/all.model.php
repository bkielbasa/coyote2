...
class Topic_All_Model extends Topic_Abstract_Model
{
	public function load()
	{
		...
		if ($this->getTags())
		{
			...
			$conditions[] = 'topic_page IN(SELECT page_id FROM page_tag WHERE tag_id = ' . $tagId . ')';
		}
