...
class Topic_User_Model extends Topic_Abstract_Model
{
	public function load()
	{
		...
		if ($this->getUserId() > User::ANONYMOUS)
		{
			$conditions[] = 'topic.topic_id In(SELECT tt.topic_id FROM topic_user tt WHERE tt.user_id = ' . (int) $this->getUserId() . ')';
		}
