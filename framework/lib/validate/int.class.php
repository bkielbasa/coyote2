...
/**
 * Walidator wartosci typu int
 */
class Validate_Int extends Validate_Abstract implements IValidate
{
	const NOT_INT = 1;
	const LESS_THAN = 2;
	...
	protected $templates = array(
			...
			self::NOT_INT			=> '"%value%" nie jest liczbą',
			self::LESS_THAN			=> 'Liczba "%value%" jest mniejsza od %min%',
